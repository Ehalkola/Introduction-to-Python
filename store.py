...
def main():
    products = [
        Product(id=12, name="Dishwasher", category="Appliances", original_price=699.9, campaign=False),
        Product(id=49, name="Kitchen table", category="Furniture", original_price=1499.9, campaign=True),
        Product(id=76, name="Oven", category="Appliances", original_price=1899.9, campaign=False),
        Product(id=101, name="Mobile phone", category="Phone", original_price=499.9, campaign=False),
        Product(id=7, name="Coffee maker", category="Appliances", original_price=199.9, campaign=True)]
    # Create a print to print the original order of products to the user, use for statement to get product to call
